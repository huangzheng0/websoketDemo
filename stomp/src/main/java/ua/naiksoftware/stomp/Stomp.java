...
public class Stomp {
     ...
     * @param uri                URI to connect
     * @param connectHttpHeaders HTTP headers, will be passed with handshake query, may be null
     * @param webSocketClient    Existing client that will be used to open the WebSocket connection, may be null to
     *                           use default client
     * @return StompClient for receiving and sending messages. Call #StompClient.connect
     */
    public static StompClient over(Class clazz, String uri, Map<String, String> connectHttpHeaders, Object
            webSocketClient) {
//        try {
//            if (Class.forName("org.java_websocket.WebSocket") != null && clazz == WebSocket.class) {
//
//                if (webSocketClient != null) {
//                    throw new IllegalArgumentException("You cannot pass a webSocketClient with 'org.java_websocket" +
//                            ".WebSocket'. use null instead.");
//                }
//
    ...
    private static OkHttpClient getOkHttpClient(Object webSocketClient) {
        if (webSocketClient != null) {
            if (webSocketClient instanceof OkHttpClient) {
                ...
                throw new IllegalArgumentException("You must pass a non-null instance of an 'okhttp3.OkHttpClient'. " +
                        "Or pass null to use a default websocket client.");
            }
        } else {
            // default http client
